...
namespace PasPasPas.Runtime.Values.IntValues {
    ...
    ///     short int value
    /// </summary>
    internal class ShortIntValue : IntegerValueBase {
        ...
        public ShortIntValue(ITypeDefinition typeDef, sbyte value) : base(typeDef, IntegralTypeKind.ShortInt)
            => this.value = value;
        ...
        public override bool Equals(IValue? other)
            => other is ShortIntValue s && s.value == value;
