...
namespace PasPasPas.Desktop.BackwardCompatibility
{
    public static class EncodingHelper
    {
        ...
        public static string GetString(this Encoding encoding, in ReadOnlySpan<byte> input)
        {
        ...
        public static void GetChars(this Encoding encoding, in ReadOnlySpan<byte> input, in Span<char> output)
        {
            var sharedBuffer = ArrayPool<byte>.Shared.Rent(input.Length);
            try
            {
