namespace PasPasPas.Parsing.SyntaxTree.ObjectPascal {
    ...
    public class Factor : SyntaxPartBase {
        ...
        ///     hex number
        /// </summary>
        public PascalHexNumber HexValue { get; set; }

        /// <summary>
        ///     int value
        /// </summary>
        public PascalInteger IntValue { get; set; }
        ...
        ///     pointer to
        /// </summary>
        public PascalIdentifier PointerTo { get; set; }

        /// <summary>
        ///     real value
        /// </summary>
        public PascalRealNumber RealValue { get; set; }
