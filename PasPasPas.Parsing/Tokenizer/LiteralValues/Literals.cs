...
namespace PasPasPas.Parsing.Tokenizer.LiteralValues {
    ...
    public static class Literals {
        ...
        private static Guid parsedIntegers =
        ...
        public static readonly Guid ParsedIntegers = parsedIntegers;

        public static Guid parsedHexNumbers =
        ...
        public static readonly Guid ParsedHexNumbers = parsedHexNumbers;

        public static Guid convertedCharLiterals =
        ...
        public static readonly Guid ConvertedCharLiterals = convertedCharLiterals;

        public static Guid convertedRealLiterals =
        ...
        public static readonly Guid ConvertedRealLiterals = convertedRealLiterals;
        ...
        public static object ParseIntegerLiteral(string value) {
            var parser = StaticEnvironment.Require<IIntegerParser>(ref parsedIntegers);
        ...
        public static object ParseHexNumberLiteral(string value) {
            var parser = StaticEnvironment.Require<IHexNumberParser>(ref parsedHexNumbers);
        ...
        public static object ConvertCharLiteral(object value) {
            var converter = StaticEnvironment.Require<ICharLiteralConverter>(ref convertedCharLiterals);
        ...
        public static object ConvertRealLiteral(object digits, object decimals, bool minus, object exponent) {
            var converter = StaticEnvironment.Require<IRealConverter>(ref convertedRealLiterals);
