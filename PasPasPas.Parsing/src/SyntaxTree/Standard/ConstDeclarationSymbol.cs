...
namespace PasPasPas.Parsing.SyntaxTree.Standard {
    ...
    public class ConstDeclarationSymbol : StandardSyntaxTreeBase {
        ...
        public ConstDeclarationSymbol(UserAttributesSymbol attributes, IdentifierSymbol identifier, Terminal colon, TypeSpecificationSymbol typeSpecification, Terminal equalsSign, ConstantExpressionSymbol value, ISyntaxPart hint, Terminal semicolon) {
