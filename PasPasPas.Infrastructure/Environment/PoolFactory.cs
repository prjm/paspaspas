...
namespace PasPasPas.Infrastructure.Environment {
    ...
    public class PoolFactory {
        ...
        public static ObjectPool<StringBuilder>.PoolItem FetchStringBuilder()
            => StaticEnvironment.Require<ObjectPool<StringBuilder>>(StaticDependency.StringBuilderPool).Borrow();
        ...
        public static ObjectPool<T>.PoolItem FetchGenericItem<T>(int id) where T : IPoolItem, new()
            => StaticEnvironment.Require<ObjectPool<T>>(id).Borrow();
